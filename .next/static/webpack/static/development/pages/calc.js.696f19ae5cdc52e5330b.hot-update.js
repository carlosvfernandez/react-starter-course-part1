  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        ...
        console.log(a); //if (!this.operators.find(lastValue)) {
...
//# sourceMappingURL=calc.js.696f19ae5cdc52e5330b.hot-update.js.map