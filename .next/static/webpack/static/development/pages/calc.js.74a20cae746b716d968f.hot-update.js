  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        ...
        console.log("es igual al +? ");
        console.log(lastValue == _data_digitsAndOperators__WEBPACK_IMPORTED_MODULE_2__["operators"][0]); //console.log("esta?" + operators.find(lastValue));
...
//# sourceMappingURL=calc.js.74a20cae746b716d968f.hot-update.js.map