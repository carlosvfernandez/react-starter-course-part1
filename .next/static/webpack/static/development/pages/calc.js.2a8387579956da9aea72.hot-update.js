...
function (_React$Component) {
  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        var lastValue = _this.state.res.charAt(_this.state.res.length - 1).toString;
...
//# sourceMappingURL=calc.js.2a8387579956da9aea72.hot-update.js.map