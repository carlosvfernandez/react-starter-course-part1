...
function (_React$Component) {
  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        if (_this.state.res.charAt(_this.state.res.length - 1) == "+") {
          var expression = _this.state.res + digit;
...
//# sourceMappingURL=calc.js.fe3831f5c318704724f4.hot-update.js.map