...
function (_React$Component) {
  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDigit", function (digit) {
      ...
      if (_this.state.res.length == 0 && digit == "." && lastValue != ".") {
        return false;
      } else {
...
//# sourceMappingURL=calc.js.8ffd3b56e663d20a41c3.hot-update.js.map