  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        ...
        var a = _this.operators.find(function (element) {
          return element > 10;
        }); //if (!this.operators.find(lastValue)) {
...
//# sourceMappingURL=calc.js.450815358ed0bfcfa32b.hot-update.js.map