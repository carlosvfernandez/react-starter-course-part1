  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        ...
        console.log(lastValue == _data_digitsAndOperators__WEBPACK_IMPORTED_MODULE_2__["operators"]); //console.log("esta?" + operators.find(lastValue));
...
//# sourceMappingURL=calc.js.e64807243f492bd0f8e4.hot-update.js.map