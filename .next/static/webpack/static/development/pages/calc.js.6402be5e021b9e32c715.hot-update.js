  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        ...
        console.log(lastValue == _data_digitsAndOperators__WEBPACK_IMPORTED_MODULE_2__["operators"]);
        console.log(_data_digitsAndOperators__WEBPACK_IMPORTED_MODULE_2__["operators"].find(function (e) {
          return e === lastValue;
        })); //console.log("esta?" + operators.find(lastValue));
...
//# sourceMappingURL=calc.js.6402be5e021b9e32c715.hot-update.js.map