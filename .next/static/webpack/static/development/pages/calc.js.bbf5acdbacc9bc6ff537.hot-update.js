...
function (_React$Component) {
  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDigit", function (digit) {
      ...
      if (_this.state.res.length == 0 && lastValue == ".") {
        return false;
      } else {
...
//# sourceMappingURL=calc.js.bbf5acdbacc9bc6ff537.hot-update.js.map