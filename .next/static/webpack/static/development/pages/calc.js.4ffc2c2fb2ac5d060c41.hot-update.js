...
function (_React$Component) {
  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        var _lastValue = _this.state.res.charAt(_this.state.res.length - 1);
...
//# sourceMappingURL=calc.js.4ffc2c2fb2ac5d060c41.hot-update.js.map