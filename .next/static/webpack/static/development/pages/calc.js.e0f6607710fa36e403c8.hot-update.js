  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        ...
        console.log(lastValue); //if (!this.operators.find(lastValue)) {
...
//# sourceMappingURL=calc.js.e0f6607710fa36e403c8.hot-update.js.map