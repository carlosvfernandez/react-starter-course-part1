  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        ...
        if (_data_digitsAndOperators__WEBPACK_IMPORTED_MODULE_2__["operators"].find(function (e) {
          return e === lastValue;
        }) != undefined) {
          var expression = _this.state.res + digit;
...
//# sourceMappingURL=calc.js.07cccd1d4ae492206856.hot-update.js.map