  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        ...
        console.log("es igual al +? " + lastValue == _data_digitsAndOperators__WEBPACK_IMPORTED_MODULE_2__["operators"][0]); //console.log("esta?" + operators.find(lastValue));
...
//# sourceMappingURL=calc.js.7324bd349f837adcedf6.hot-update.js.map