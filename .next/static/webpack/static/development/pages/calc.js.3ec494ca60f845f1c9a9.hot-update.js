  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        ...
        console.log(_this.operators.find(lastValue)); //if (!this.operators.find(lastValue)) {
...
//# sourceMappingURL=calc.js.3ec494ca60f845f1c9a9.hot-update.js.map