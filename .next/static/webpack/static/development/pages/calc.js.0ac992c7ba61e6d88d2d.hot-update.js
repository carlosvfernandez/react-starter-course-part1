  ...
  function Calculator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOperator", function (digit) {
      if (_this.state.res != "") {
        ...
        console.log(_this.state.res.length); //const a = lastValue == operators[0];

        console.log("esta?" + _data_digitsAndOperators__WEBPACK_IMPORTED_MODULE_2__["operators"].find(lastValue)); //if (!this.operators.find(lastValue)) {
...
//# sourceMappingURL=calc.js.0ac992c7ba61e6d88d2d.hot-update.js.map